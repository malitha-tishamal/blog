...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "screenshot": [
      ...
      "https://malithatishamal.42web.io/img/portfolio/app/ceytrack/3.png"
    ],
    "offers": {
      "@type": "Offer",
  ...
  <style>
    ...
    .demo-card:hover {
      ...
      box-shadow: 0 10px 20px rgba(39, 100, 231, 0.1);
      border-color: #2764E7;
    }
    ...
    .btn-next-project, .btn-contact-me {
      padding: 12px 24px;
      border-radius: 5px;
      text-decoration: none;
      transition: all 0.3s ease;
            ...
            <div class="portfolio-details-media">
             ...
             <div class="portfolio-details-slider swiper init-swiper" data-aos="zoom-in">
              ...
              <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
                <h5 class="mt-4 mb-3">📱 Application Screen Flow</h5>
                <div class="row g-2">
                  <div class="col-4">
              ...
              <div class="tech-stack-section mt-4" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="tech-stack-badges">
                  ...
                  <span class="tech-badge firestore">Cloud Firestore</span>
              ...
              <div class="database-section mt-4" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="database-schema">
                  <div class="collection-item">
                    ...
                    <div>
                      <strong>users</strong>
                      <small>User profiles with role (factory_owner/land_owner)</small>
                    </div>
                  </div>
                  <div class="collection-item">
                    ...
                    <div>
                      ...
                      <small>Export orders with status tracking</small>
                    </div>
                  </div>
                  <div class="collection-item">
                  ...
                  <div class="collection-item">
                    ...
                    <div>
                      ...
                      <small>Factory information and operations</small>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row g-3">
                    <div class="col-md-6">
                      <div class="problem-card">
                        <div class="card-header">
                          ...
                          <h5>Traditional Problems</h5>
                        </div>
                        <div class="card-body">
                          <ul>
                            <li>Manual order tracking on paper</li>
                            <li>No real-time supply chain visibility</li>
                    ...
                    <div class="col-md-6">
                      <div class="solution-card">
                        ...
                        <div class="card-body">
                          <ul>
                            <li>Automated digital order management</li>
                            <li>Real-time dashboard for both roles</li>
                  ...
                  <div class="accordion-item" data-aos="fade-up" data-aos-delay="100">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#portfolio-details-collapse-2" aria-expanded="false" aria-controls="collapseTwo">
                        <i class="bi bi-people me-2"></i> 2. User Roles & Architecture
                      </button>
                    </h2>
                  ...
                  <div class="row g-3">
                    <div class="col-md-4">
                      <div class="demo-card">
                        ...
                        <h6>App Intro</h6>
                        <p>Login, Agreement, Intro Screen</p>
                        <a href="https://shorturl.at/tRUIH" target="_blank" class="btn-demo">
                    ...
                    <div class="col-md-4">
                      <div class="demo-card">
                        ...
                        <h6>Factory Owner Login</h6>
                        <p>Factory Dashboard & Features</p>
                        <a href="https://shorturl.at/bgoVl" target="_blank" class="btn-demo">
                          <i class="bi bi-play-circle"></i> Watch Demo
                        </a>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="demo-card">
                        ...
                        <h6>Land Owner Login</h6>
                        <p>Farmer Dashboard & Features</p>
                        <a href="https://shorturl.at/3n6Tj" target="_blank" class="btn-demo">
                          <i class="bi bi-play-circle"></i> Watch Demo
                        </a>
                      </div>
                    </div>
